...
var $author$project$PlantCalendar$Zipcode = F3(
	function (zone, lat, lon) {
		return {lat: lat, lon: lon, zone: zone};
	});
...
var $author$project$PlantCalendar$init = function (_v0) {
	return _Utils_Tuple2(
		A5(
			...
			A3($author$project$PlantCalendar$Zipcode, '-1', '-1', '-1'),
			'',
...
var $author$project$PlantCalendar$jsonDecoder = A4(
	$elm$json$Json$Decode$map3,
	$author$project$PlantCalendar$Zipcode,
	A2($elm$json$Json$Decode$field, 'zone', $elm$json$Json$Decode$string),
	A2($elm$json$Json$Decode$field, 'rangemin', $elm$json$Json$Decode$string),
	A2($elm$json$Json$Decode$field, 'rangemax', $elm$json$Json$Decode$string));
var $elm$core$Basics$not = _Basics_not;
var $author$project$PlantCalendar$togglePlant = F2(
	function (target, test) {
		return _Utils_eq(test, target) ? _Utils_update(
			test,
					...
					$elm$http$Http$get(
						{
							...
							url: 'https://c0bra.api.stdlib.com/zipcode-to-hardiness-zone/?zipcode=' + searchZip
						}));
			case 'SetZipcodeText':
				var str = msg.a;
				return _Utils_Tuple2(
					...
					return _Utils_Tuple2(
						_Utils_update(
							model,
							{
								...
								zipcode: A3($author$project$PlantCalendar$Zipcode, '-1', '-1', '-1')
							}),
						$elm$core$Platform$Cmd$none);
				}
			case 'TogglePlant':
...
var $author$project$PlantCalendar$SetZipcode = {$: 'SetZipcode'};
...
var $author$project$PlantCalendar$getPHZ = function (status) {
	switch (status.$) {
		...
		case 'Loading':
			return 'Loading...';
		default:
			return 'Please set ZIP Code to find Plant Hardiness Zone. The default (Zone 5) will be used until you do.';
	}
};
					...
					[
						...
						_List_fromArray(
							[
								...
								_List_fromArray(
									[
										$elm$html$Html$Attributes$class('sidebar__top')
									]),
								_List_fromArray(
									[
										A2(
											...
											[
												...
												_List_fromArray(
													[
														...
														$elm$html$Html$Events$onInput($author$project$PlantCalendar$SetZipcodeText),
														$elm$html$Html$Attributes$value(model.zipcodetext)
													]),
												_List_Nil),
												A2(
												...
												_List_fromArray(
													[
														$elm$html$Html$Events$onClick($author$project$PlantCalendar$SetZipcode)
													]),
												_List_fromArray(
													[
								...
								_List_fromArray(
									[
										$elm$html$Html$Attributes$class('sidebar__bottom')
									]),
								_List_fromArray(
									[
										A2(
										...
										_List_fromArray(
											[
												$elm$html$Html$Attributes$class('crop__list')
											]),
										A2($author$project$PlantCalendar$getPlants, 0, sidebarPlants))
									]))
							])),
						A2(
						$elm$html$Html$main_,
...
var $author$project$PlantCalendar$main = $elm$browser$Browser$element(
	{init: $author$project$PlantCalendar$init, subscriptions: $author$project$PlantCalendar$subscriptions, update: $author$project$PlantCalendar$update, view: $author$project$PlantCalendar$view});
_Platform_export({'PlantCalendar':{'init':$author$project$PlantCalendar$main(
